...
pacman_packages=(git stow neovim curl bash-completion fish fd the_silver_searcher fzf xclip diff-so-fancy fasd tree bat htop tldr pass albert ranger w3m poppler)
